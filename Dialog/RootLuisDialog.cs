namespace AracKiralama
{
    ...
    [LuisModel("31f4fbd1-d876-4940-8349-cc28eebeb3dd", "57bef097d54849f1bc53458bf4157cbc")]
    [Serializable]
        ...
        public async Task SearchCar(IDialogContext context, LuisResult result)
         {
            ...
            else if (result.Entities.Count > 0 && selectedCar.AracMarka != "audi" && selectedCar.AracMarka != "vw")
            {
                this.ShowOptions(context);
            }
